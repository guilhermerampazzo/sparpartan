...
export function NovoClienteInlineLoja({
  onCriado,
}: {
  ...
  return (
    <div className="space-y-3 rounded-lg border border-dashed border-outline-variant p-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <Campo label="CPF/CNPJ" name="clienteNovoCpfCnpj" required defaultValue={valores?.clienteNovoCpfCnpj} />
        <Campo label="Telefone" name="clienteNovoTelefone" defaultValue={valores?.clienteNovoTelefone} />
        <Campo label="E-mail" name="clienteNovoEmail" type="email" defaultValue={valores?.clienteNovoEmail} />
      </div>
